    ...
    return (
        <nav className="h-20 flex border-b justify-between font-medium bg-white">
            ...
            <div className="hidden lg:flex">
                <Button 
                  variant="secondary"
                  className="border-l border-t-0 border-b-0 border-r-0 px-12 h-full rounded-none bg-white hover:bg-[#ffc654] transition-colors text-lg"
                >
                    <Link href="/login">
                        Log in
                    </Link>
                ...
                <Button 
                  variant="secondary"
                  className="border-l border-t-0 border-b-0 border-r-0 px-12 h-full rounded-none bg-black text-white hover:bg-[#ffc654] hover:text-black transition-colors text-lg"
                >
                    <Link href="/signup">
                        Start Selling
                    </Link>
