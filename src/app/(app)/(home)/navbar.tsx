...
export const Navbar = () => {
    ...
    return (
        <nav className="h-20 flex border-b justify-between font-medium bg-white">
            ...
            <div className='items-center gap-4 hidden lg:flex pr-6 text-sm'>
            ...
            <div className="hidden lg:flex"> 
                ...
                asChild 
                variant="secondary"
                className="border-l border-t-0 border-b-0 border-r-0 px-10 h-full rounded-none bg-white hover:bg-black hover:text-white transition-colors text-lg"
                >
                    <Link href="/login">
                        Log In
                    </Link> 
