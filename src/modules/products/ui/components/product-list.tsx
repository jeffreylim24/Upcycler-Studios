...
export const ProductList = ({ category }: Props) => {
  ...
  const { 
  ...
  } = useSuspenseInfiniteQuery(trpc.products.getMany.infiniteQueryOptions( 
    {
      ...
      tags: filters.tags,
      sort: filters.sort || "curated", // <-- ensure a default is sent
      limit: DEFAULT_LIMIT
    },
    {
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-4'>
        {data?.pages.flatMap((page) => page.docs).map((product) => (
          <ProductCard 
            ...
            authorUsername='username' // TODO: Replace with actual author username
            authorImageUrl={undefined} // TODO: Replace with actual author image URL
